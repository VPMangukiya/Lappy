                                    ...
                                    <div class="card-body">
                                        <table id="employee_data" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                              ...
                                              $select_cat="SELECT * FROM orders where customer_email = '".$_SESSION['uname']."' ORDER BY id DESC";
                                            ...
                                            while ($row_cart=mysqli_fetch_array($run_cart)) {
                                                ...
                                                <?php 
                                                $select_cats="SELECT DISTINCT order_date FROM customer_orders WHERE order_id='$id' and customer_email = '".$_SESSION['uname']."'  ORDER BY order_id DESC";
                                                ...
                                                $bill=0;
                                                $total=0;
                                                $select_total="SELECT * FROM customer_orders WHERE order_id='$id' and customer_email = '".$_SESSION['uname']."' ORDER BY order_id DESC ";
                                                ...
                                                <?php 
                                                $select_pays="SELECT DISTINCT txnid,payment_status FROM customer_orders WHERE order_id='$id' and customer_email = '".$_SESSION['uname']."' ORDER BY order_id DESC ";
                                                ...
                                                ?> 
                                                 <?php 
                                                $select_payss="SELECT DISTINCT order_status FROM customer_orders WHERE order_id='$id' and customer_email = '".$_SESSION['uname']."' ORDER BY order_id DESC ";
                                                ...
                                                while ($row_payss=mysqli_fetch_array($run_payss)) {
                                                    ...
                                                    ?>
                                                <td><a href="MY.php?pid=<?php echo $row_cart['id']?>"  class="btn btn-primary btn-sm btn-rounded waves-effect waves-light view_data">order details</a></td>
